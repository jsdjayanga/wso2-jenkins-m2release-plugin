...
public class ForkedSupportRepoVersionInfoTest {

    private String version = "2.2.3-wso2v342323410.77-SNAPSHOT";
    private ForkedSupportRepoVersionInfo dvi = null;

    @Before
    public void setUp() throws VersionParseException {
        dvi = new ForkedSupportRepoVersionInfo(version);
    }
    ...
    public void getReleaseVersionStringTest() {
        Assert.assertEquals("2.2.3-wso2v342323410.77", dvi.getReleaseVersionString());
    }
    ...
    public void getNextVersionTest() {
        Assert.assertEquals("2.2.3-wso2v342323410.78-SNAPSHOT", dvi.getNextVersion().getSnapshotVersionString());
        Assert.assertEquals("2.2.3-wso2v342323410.78", dvi.getNextVersion().getReleaseVersionString());
